...
var import_dist, import_dist2, import_dist3, end_of_stream, finished, DEFAULT_ENCODING;
...
function ecdsa(Point2, ecdsaOpts, curveOpts = {}) {
  ...
  function int2octets(num2) {
    aInRange("num < 2^" + fnBits, num2, _0n, ORDER_MASK);
...
function lift_x(x) {
  aInRange("x", x, _1n2, secp256k1_CURVE.p);
  const xx = modP(x * x);
...
function schnorrVerify(signature2, message, publicKey2) {
  ...
  try {
    ...
    if (!inRange(r, _1n2, secp256k1_CURVE.p))
      return false;
    const s = num(sig.subarray(32, 64));
    if (!inRange(s, _1n2, secp256k1_CURVE.n))
      return false;
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-3OO7JKPO.js.map
