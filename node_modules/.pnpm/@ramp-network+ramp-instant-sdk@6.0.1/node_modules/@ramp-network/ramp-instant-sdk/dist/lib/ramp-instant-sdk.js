...
var RampInstantSDK = /** @class */ (function () {
    ...
    RampInstantSDK.prototype.unsubscribe = function (type, callback) {
        ...
        if (type === '*') {
            ...
            this._listeners[type] = (_a = this._listeners[type]) === null || _a === void 0 ? void 0 : _a.filter(function (l) { return l.callback !== callback; });
        }
        return this;
    };
    RampInstantSDK.prototype._on = function (type, callback, internal) {
        ...
        if (type === '*') {
            ...
            (_a = this._listeners[type]) === null || _a === void 0 ? void 0 : _a.push({ callback: callback, internal: internal });
        }
    };
    ...
    RampInstantSDK.prototype._registerSdkEventHandlers = function () {
        var _this = this;
        this._on(types_1.InternalEventTypes.APP_VERSION, function (event) {
            var _a, _b;
            ...
            if (parsedMajor >= 2 && ((_b = _this.domNodes) === null || _b === void 0 ? void 0 : _b.iframe)) {
                (0, init_helpers_1.makeIframeResponsive)(_this.domNodes.iframe, _this.domNodes.container, _this._config.containerNode);
                _this._makeVisible();
        ...
        this._on(types_1.WidgetEventTypes.WIDGET_CONFIG_DONE, function () { return _this._onConfigEvent(); }, true);
        this._on(types_1.WidgetEventTypes.WIDGET_CONFIG_FAILED, function () { return _this._onConfigEvent(); }, true);
    ...
    RampInstantSDK.prototype._dispatchEvent = function (event) {
        var _a;
        var type = event.type;
        (_a = this._listeners[type]) === null || _a === void 0 ? void 0 : _a.forEach(function (handler) { return handler.callback(event); });
    };
    ...
    RampInstantSDK.prototype._removeEscapeHandler = function () {
    ...
    RampInstantSDK.prototype._showUsingOverlayMode = function () {
        ...
        this._isVisible = true;
        (0, body_scroll_lock_1.disableBodyScroll)();
    };
    ...
    RampInstantSDK.prototype._getHostConfigSdkParams = function (config, useSendCryptoCallback) {
        ...
        return __assign({ sdkType: 'WEB', sdkVersion: consts_1.SDK_VERSION, variant: widgetVariant, widgetInstanceId: (0, utils_1.getRandomIntString)(), closeable: closeable }, (useSendCryptoCallback
            ? { useSendCryptoCallbackVersion: consts_1.SEND_CRYPTO_SUPPORTED_VERSION }
            : {}));
    };
    RampInstantSDK.prototype._makeVisible = function () {
        var _a, _b;
        if (this._isConfiguredAsHosted()) {
            return;
        }
    ...
    RampInstantSDK.prototype._onConfigEvent = function () {
        this._makeVisible();
    };
