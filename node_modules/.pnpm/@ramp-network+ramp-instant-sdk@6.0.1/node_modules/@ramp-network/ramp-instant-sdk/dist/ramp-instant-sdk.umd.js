/* Version: 6.0.1 - June 11, 2025 16:48:52 */
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    (function (InternalEventTypes) {
        InternalEventTypes["APP_VERSION"] = "APP_VERSION";
    ...
    function initDOMNodeWithOverlay(url, dispatch, config) {
        ...
        var iframe = prepareIframeNode(url, config.variant, undefined, config.credentialless);
    ...
    var RampInstantSDK = /** @class */ (function () {
        ...
        RampInstantSDK.prototype._registerSdkEventHandlers = function () {
            ...
            this._on(exports.RampInstantEventTypes.WIDGET_CONFIG_DONE, function () { return _this._onConfigEvent(); }, true);
            this._on(exports.RampInstantEventTypes.WIDGET_CONFIG_FAILED, function () { return _this._onConfigEvent(); }, true);
        ...
        RampInstantSDK.prototype._getHostConfigSdkParams = function (config, useSendCryptoCallback) {
            ...
            return __assign({ sdkType: 'WEB', sdkVersion: SDK_VERSION, variant: widgetVariant, widgetInstanceId: getRandomIntString(), closeable: closeable }, (useSendCryptoCallback
