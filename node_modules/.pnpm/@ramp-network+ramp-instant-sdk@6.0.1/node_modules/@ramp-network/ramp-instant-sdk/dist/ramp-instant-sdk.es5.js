...
var RampInstantSDK = /** @class */ (function () {
    ...
    RampInstantSDK.prototype._registerSdkEventHandlers = function () {
        ...
        this._on(WidgetEventTypes.WIDGET_CONFIG_DONE, function () { return _this._onConfigEvent(); }, true);
        this._on(WidgetEventTypes.WIDGET_CONFIG_FAILED, function () { return _this._onConfigEvent(); }, true);
