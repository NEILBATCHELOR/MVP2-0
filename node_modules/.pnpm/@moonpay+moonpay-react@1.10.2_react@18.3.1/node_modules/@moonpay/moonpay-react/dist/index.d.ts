...
interface VirtualAccountWidgetQueryParams extends ThemeQueryParams {
    ...
    walletAddress?: string;
    /**
     * Network codes of the tokens the customer is sending. ['sol', 'eth', 'polygon']
     */
    networkCodes?: string[];
    /**
...
export { MoonPayBalanceDepositWidget, MoonPayBalanceWithdrawWidget, MoonPayBuyWidget, MoonPayConsumerKycWidget, MoonPayContext, MoonPayNftCheckoutWidget, MoonPayNftClaimWidget, MoonPayProvider, MoonPaySellWidget, MoonPaySwapWidget, MoonPaySwapsCustomerSetupWidget, MoonPayTopUpLedgerWidget, MoonPayTopUpWidget, MoonPayTransactionTrackerWidget, MoonPayWithdrawLedgerWidget };
